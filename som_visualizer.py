...
class SOMVisualizer:
    def __init__(self, som: SOM, font_path: str = None):
        ...
        self.topology = self.som._topology
    ...
    def plot_umatrix(self, colormap: str = 'bone_r', show_data_points: bool = False, show_legend: bool = True):
        ...
        # Check the topology of the SOM
        if self.topology == 'rectangular':
            self._plot_rectangular_topology(umatrix, colormap, show_data_points, show_legend, _point_size, fontsize, ax)
        elif self.topology == 'hexagonal':
            # Plot hexagonal topology
            self._plot_hexagonal_topology(umatrix, colormap, show_data_points, show_legend, _point_size, fontsize, ax)
        elif self.topology == 'circular':
            # Plot circular topology
            self._plot_circular_topology(umatrix, colormap, show_data_points, show_legend, _point_size, fontsize, ax)
        else:
            raise ValueError("Unsupported topology: {}".format(self.som.topology))
