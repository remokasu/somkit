...
som_visualizer.plot_umatrix(
    ...
    file_name="umatrix_breast_cancer.png",
    show=False,
)
...
som_visualizer.plot_component_planes(
    title=None,  # Optional title for the plot (default: None, no title)
    file_name="component_planes_breast_cancer.png",
    show=False,
)
...
som_visualizer.plot_hit_map(
    title=None,  # Optional title for the plot (default: None, no title)
    file_name="hit_map_breast_cancer.png",
    show=False,
)
...
som_visualizer.plot_class_distribution(
    title=None,  # Optional title for the plot (default: None, no title)
    file_name="class_distribution_breast_cancer.png",
    show=False,
)
...
som_visualizer.plot_sammon_projection(
    ...
    show_legend=True,
    title=None,  # Optional title for the plot (default: None, no title)
    file_name="sammon_projection_breast_cancer.png",
    show=False,
)
