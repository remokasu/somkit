...
som_visualizer.plot_component_planes(
    title=None,  # Optional title for the plot (default: None, no title)
    file_name="component_planes_iris.png",
    show=False,
)
...
som_visualizer.plot_class_distribution(
    title=None,  # Optional title for the plot (default: None, no title)
    file_name="class_distribution_iris.png",
    show=False,
)
...
som_visualizer.plot_sammon_projection(
    ...
    node_size=200,
    data_point_size=100,
    connection_style="spring",  # or "line"
    colormap="viridis",
    max_iter=500,
    learning_rate=0.2,
    random_state=random_seed,
    title=None,  # Optional title for the plot (default: None, no title)
    # title="Sammon's Mapping of Iris Dataset",  # Example with custom title
    file_name="sammon_projection_iris.png",
    show=False,
)
